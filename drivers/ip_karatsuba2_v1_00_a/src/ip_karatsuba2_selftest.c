/*****************************************************************************
* Filename:          E:\Code_Doctorat_Virtex5\Projet_Karatsuba2\Simulation/drivers/ip_karatsuba2_v1_00_a/src/ip_karatsuba2_selftest.c
* Version:           1.00.a
* Description:       Contains a diagnostic self-test function for the ip_karatsuba2 driver
...
XStatus IP_KARATSUBA2_SelfTest(void * baseaddr_p)
{
  ...
  IP_KARATSUBA2_mWriteSlaveReg0(baseaddr, 0, 1);
  Reg32Value = IP_KARATSUBA2_mReadSlaveReg0(baseaddr, 0);
  ...
  IP_KARATSUBA2_mWriteSlaveReg1(baseaddr, 0, 2);
  Reg32Value = IP_KARATSUBA2_mReadSlaveReg1(baseaddr, 0);
  ...
  IP_KARATSUBA2_mWriteSlaveReg2(baseaddr, 0, 3);
  Reg32Value = IP_KARATSUBA2_mReadSlaveReg2(baseaddr, 0);
